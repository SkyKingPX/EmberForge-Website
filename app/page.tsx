              ...
              <span
                  className="bg-gradient-to-r from-[#5A4FCF] via-[#7868E6] to-[#A29BFE] text-transparent bg-clip-text">KineticHosting</span>
                        ...
                        <motion.p
                            ...
                            transition={{duration: 0.5, delay: 0.1}}
                        >
                            We are partnered with KineticHosting to provide you with the best Minecraft server hosting
                            experience.
                        </motion.p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        ...
                        >
                            ...
                            <p className="text-foreground/80">
                                ...
                                servers with a
                                reputation for reliability, performance, and exceptional customer service. As a trusted
                                partner for
                                gaming communities worldwide, they deliver high-quality hosting solutions designed to
                                keep your gameplay
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-foreground/70">Powered by cutting-edge server
                                            infrastructure with
                                            powerful CPUs and high-speed NVMe SSDs for optimal performance and minimal
                                            lag.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-foreground/70">Full compatibility with all Minecraft
                                            versions (Java and
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-foreground/70">Intuitive control panel for effortless
                                            server management
