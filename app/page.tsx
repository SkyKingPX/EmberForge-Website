...
import { ArrowDown, Flame, Code, Server, Package, ArrowRight, Github, ExternalLink } from "lucide-react"
  ...
  return (
    <main className="min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-foreground/80 max-w-lg">
                EmberForge Development creates high-quality Minecraft mods, plugins, and tools that enhance gameplay and
                server management.
              </p>
            ...
            >
              <div className="relative w-full aspect-square max-w-md mx-auto">
                ...
                <motion.div className="relative w-full h-full rounded-2xl overflow-hidden border-2 border-primary/30 animate-float">
                  <img
      ...
      <motion.section
        ...
        className="py-10 md:py-22 relative overflow-hidden"
      >
        {/* Background Elements */}
        <div className="absolute inset-0 -z-10">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              We are a passionate team of developers dedicated to creating exceptional Minecraft content. Our mission is
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <motion.p
              ...
              transition={{ duration: 0.5, delay: 0.1 }}
            >
              Discover our collection of Minecraft mods, plugins, and resource packs that have been downloaded by
                          ...
                          <div className="flex gap-2">
                            ...
                            <Button size="sm" variant="ghost" className="w-9 h-9 p-0" asChild>
                              <a href={project.links.curseforge} target="_blank" rel="noopener noreferrer">
                                <img src="/assets/curseforge.svg" alt="CurseForge" width={20} height={20}
                            ...
                            <Button size="sm" variant="ghost" className="w-9 h-9 p-0" asChild>
                              <a href={project.links.modrinth} target="_blank" rel="noopener noreferrer">
                                <img src="/assets/modrinth.png" alt="Modrinth" className="h-5 w-5"/>
      ...
      {/* KineticHosting */}
      <section className="py-10 md:py-22 relative overflow-hidden">
        {/* Background Elements */}
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-1/4 right-1/3 w-64 h-64 bg-[#2662ea]/10 rounded-full blur-3xl" />
          <div className="absolute bottom-1/3 left-1/4 w-72 h-72 bg-[#6a22a9]/10 rounded-full blur-3xl" />
        </div>
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <motion.h2
                ...
                transition={{ duration: 0.5 }}
            >
              <span className="bg-gradient-to-r from-[#2662ea] to-[#6a22a9] text-transparent bg-clip-text">KineticHosting</span>
            </motion.h2>
            <motion.p
                className="text-lg text-foreground/80"
                initial={{ opacity: 0, y: 20 }}
                ...
                transition={{ duration: 0.5, delay: 0.1 }}
            >
              We are partnered with KineticHosting to provide you with the best Minecraft server hosting experience.
            </motion.p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <motion.div
              ...
              className="space-y-6"
            >
              <h3 className="text-2xl font-bold">Premium Game Server Hosting</h3>
              <p className="text-foreground/80">
                KineticHosting is a premium game server hosting provider specializing in Minecraft servers with a reputation for reliability, performance, and exceptional customer service. As a trusted partner for gaming communities worldwide, they deliver high-quality hosting solutions designed to keep your gameplay smooth and uninterrupted.
              </p>
              
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <Server className="h-5 w-5 text-[#2662ea] mt-1" />
                  <div>
                    <h4 className="font-medium">High-Performance Hardware</h4>
                    <p className="text-sm text-foreground/70">Powered by cutting-edge server infrastructure with powerful CPUs and high-speed NVMe SSDs for optimal performance and minimal lag.</p>
                  </div>
                </div>
                
                <div className="flex items-start gap-3">
                  <Package className="h-5 w-5 text-[#2662ea] mt-1" />
                  <div>
                    <h4 className="font-medium">Complete Minecraft Support</h4>
                    <p className="text-sm text-foreground/70">Full compatibility with all Minecraft versions (Java and Bedrock) and comprehensive modpack support with easy installations.</p>
                  </div>
                </div>
                
                <div className="flex items-start gap-3">
                  <Code className="h-5 w-5 text-[#2662ea] mt-1" />
                  <div>
                    <h4 className="font-medium">User-Friendly Experience</h4>
                    <p className="text-sm text-foreground/70">Intuitive control panel for effortless server management with instant setup and full configuration access.</p>
                  </div>
                </div>
              </div>
              
              <div className="flex items-start mt-12 gap-4">
                <Button className="bg-gradient-to-r from-[#2662ea] to-[#6a22a9] hover:opacity-90 text-white hover-scale" asChild>
                  <a href="https://billing.kinetichosting.net/aff.php?aff=1075" target="_blank" rel="noopener noreferrer">
                    Get Started <ArrowRight className="ml-2 h-4 w-4" />
                  </a>
                </Button>
                <Button variant="outline" className="hover-scale" asChild>
                  <a href="https://www.kinetichosting.net/game-servers/minecraft/order" target="_blank" rel="noopener noreferrer">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="relative overflow-hidden rounded-xl border border-[#2662ea]/20 bg-card theme-transition">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#2662ea] to-[#6a22a9]"></div>
                <div className="p-6">
                  <h3 className="text-xl font-bold mb-4">Why Choose KineticHosting?</h3>
                  <ul className="space-y-3">
                    <li className="flex items-center gap-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#2662ea]"></div>
                  ...
                  <div className="mt-6 p-4 rounded-lg bg-[#2662ea]/5 border border-[#2662ea]/10">
                    <p className="text-sm italic text-center text-foreground/80">
                      "KineticHosting's commitment to performance, reliability and customer satisfaction makes them an ideal partner for hosting your Minecraft server."
                    </p>
                  </div>
                </div>
              </div>
