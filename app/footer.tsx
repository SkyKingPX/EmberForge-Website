                    ...
                    >
                        <div className="flex items-center gap-3 mb-6">
                            <div className="relative w-10 h-10">
                                ...
                                <div
                                    className="absolute inset-0 flex items-center justify-center text-primary-foreground font-bold text-lg">
                                    EF
                                </div>
                            </div>
                        ...
                        <p className="text-foreground/70 mb-6 leading-relaxed">
                            Crafting exceptional Minecraft experiences through innovative mods, plugins, and tools that
                            ignite
